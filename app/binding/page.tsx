...
export default function BindingPage() {
  ...
  const filteredData = useMemo(() => {
    return mockBindings.filter((item) => {
  ...
  const columns: Column<DeviceBinding>[] = [
    ...
    { key: 'bindingTime', header: '绑定时间', width: '160px' },
    {
      key: 'bindingStatus',
      header: '绑定状态',
      width: '100px',
      render: (item) => <StatusBadge status={item.bindingStatus} />,
    },
  ]
